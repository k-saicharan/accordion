...
A new drafting session is beginning. Read `session_primer.md` for project context and `mission.md` for current scene state. Then confirm the current scene with the director and begin Step 1.
